...
public final class CassandraInserts extends NoSqlDbInserts {
    ...
    private final int max_size = 50;  // Max size of the buffer in bytes
    private static int current_size = 0; // The current size of the queries in bytes
    ...
    public NoSqlDbInserts insert(FieldValue fv, FieldValue... fvs) {
        ...
        current_size += insertQuery.toString().getBytes().length;
