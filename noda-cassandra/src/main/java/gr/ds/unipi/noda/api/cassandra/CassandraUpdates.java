...
final class CassandraUpdates extends NoSqlDbUpdates {
    ...
    private static int updateBufferSize = 0;
    ...
    public NoSqlDbUpdates update(FilterOperator filterOperator, FieldValue fv, FieldValue... fvs) {
        ...
        updateBufferSize += filterOperator.toString().length()*2;
        ...
        updateBufferSize += assignments.toString().length()*2;
        if(updateBufferSize > 50 ){
            flush();
        }
        return this;
    }
