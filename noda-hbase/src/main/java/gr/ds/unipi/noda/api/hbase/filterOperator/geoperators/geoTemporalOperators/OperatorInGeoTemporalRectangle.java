...
import gr.ds.unipi.noda.api.hbase.filterOperator.geoperators.geoTemporalOperators.customFilters.RectangleTemporalFilter;
import gr.ds.unipi.noda.api.hbase.filterOperator.geoperators.geoTemporalOperators.customFilters.generated.RectangleTemporalFilterProtos;
...
final class OperatorInGeoTemporalRectangle extends GeoTemporalOperator<Rectangle, TemporalBounds> {
    ...
    protected Filter geometryRefactor() {
        ...
        return RectangleTemporalFilter.newRectangleTemporalFilter(Bytes.toBytes(getGeographicalOperator().getFieldName()), Bytes.toBytes("lon"),Bytes.toBytes("lat"),lowerCoordinates, upperCoordinates, Bytes.toBytes(temporalNames[0]), Bytes.toBytes(temporalNames[1]), getTemporalType().getLowerBound().getTime(), getTemporalType().getUpperBound().getTime());
    }
