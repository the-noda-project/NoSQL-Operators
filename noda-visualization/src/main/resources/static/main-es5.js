  ...
  ["main"],
  {
    ...
    \****************************************/
      ...
      function srcAppHomeHomeComponentTs(
        ...
        var _asymmetrik_ngx_leaflet__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! @asymmetrik/ngx-leaflet */
          "./node_modules/@asymmetrik/ngx-leaflet/__ivy_ngcc__/dist/index.js"
        );
        /* harmony import */

        var ng5_slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ng5-slider */
        ...
        var HomeComponent = /*#__PURE__*/ (function () {
          function HomeComponent(quoteService, activeRoute) {
          ...
          _createClass(HomeComponent, [
            {
              ...
              value: function ngOnInit() {
                ...
                this.activeRoute.paramMap.subscribe(function (params) {
                  var caseOfView = params.get("case");
                ...
                if (this.isSpatial === false) {
                  ...
                  this.data = parsedData["data"]; // JS Date needs milli Epoch Timestamp (so below is a milli epoch converter)
                  ...
                  var _parsedData = JSON.parse(this.dataFromServer);

                  this.data = _parsedData["data"];
                  ...
                  if (position.id) {
                    ...
                    _this5.layers.push(
                      leaflet__WEBPACK_IMPORTED_MODULE_3__["circleMarker"](
                        ...
                        {
                          renderer: myRenderer,
                          color: _this5.getRGBofPin(position.id),
                          fillColor: _this5.getRGBofPin(position.id),
                          fill: true,
                          stroke: false,
                          fillOpacity: 1,
                        }
                      ...
                      _this6.groupedData[key].forEach(function (element) {
                        ...
                        _this6.layers.push(
                          leaflet__WEBPACK_IMPORTED_MODULE_3__["circleMarker"](
                            ...
                            {
                              renderer: myRenderer,
                              color: _this6.getRGBofPin(element.id),
                              fillColor: _this6.getRGBofPin(element.id),
                              fill: true,
                              stroke: false,
                              fillOpacity: 1,
                            }
                ...
                this.queryConstructionServ
                  ...
                  .then(function (res) {
                    ...
                    if (data["status"] === "ok") {
                      ...
                      _this7.quoteService.updateData(res);

                      _this7.modal.dismissAll();

                      _this7.router.navigate(["/visualization/" + "spatial"]);
                    } else {
                ...
                this.queryConstructionServ
                  ...
                  .then(function (res) {
                    ...
                    if (data["status"] === "ok") {
                      ...
                      _this8.quoteService.updateData(res);
    ...
    \********************************************************************/
      ...
      function srcAppQueryConstructionQueryConstructionComponentTs(
        ...
        var _fieldnames_modal_fieldnames_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        var QueryConstructionComponent = /*#__PURE__*/ (function () {
          function QueryConstructionComponent(modal) {
          ...
          _createClass(QueryConstructionComponent, [
            ...
            {
              key: "openModal",
              value: function openModal(selsectedCase) {
                if (this.query) {
                  var x = this.modal.open(
          ...
          _createClass(SidebarComponent, [
            {
              ...
              value: function ngOnInit() {
                ...
                this.quoteService.getNodaSTData().then(function (res) {
                  var parsedData = JSON.parse(res);
                  _this9.data = parsedData["data"];
                  _this9.groupedData = lodash__WEBPACK_IMPORTED_MODULE_2__[
                    "groupBy"
                  ](_this9.data, "time");
                });
              },
