...
class OperatorInGeographicalRectangle extends GeoSpatialOperator<Rectangle> implements RedisGeoSpatialOperator {
    ...
    static OperatorInGeographicalRectangle newOperatorInGeographicalRectangle(String fieldName, Rectangle rectangle) {
